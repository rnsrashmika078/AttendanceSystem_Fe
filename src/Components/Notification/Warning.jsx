...
function Warning({ messageBody, setNotifierVisibility }) {
  return (
    <div>
      <div className="fixed top-25 right-5  z-50 flex items-center justify-center">
        <div
          id="toast-warning"
        ...
        >
          ...
          <div className="ms-3 text-sm font-normal">{messageBody}</div>
          <button
            type="button"
            className="ms-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700"
            data-dismiss-target="#toast-warning"
            aria-label="Close"
            onClick={() => setNotifierVisibility(false)}
          >
